      ...
      <div className="bg-white dark:bg-[#141416] border border-slate-200 dark:border-zinc-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            />
            <label htmlFor="redis-ssl-toggle" className="text-xs text-slate-700 dark:text-zinc-300 font-medium cursor-pointer flex items-center gap-1">
          ...
          {testResult && (
            <div
              className={`p-3 rounded-xl border flex items-start gap-2.5 text-xs animate-in fade-in duration-100 ${testResult.success
