...
export const Sidebar: React.FC<SidebarProps> = ({
      ...
      <div key={item.id} className="relative select-none">
        <div
          ...
          className={
            ...
            (isSelected
              ? 'bg-surface-800 text-white font-medium shadow-sm border-l-2 border-amber-400'
          ...
          {isEditing ? (
            ...
            >
              <input
                ...
                className="w-full px-1.5 py-0.5 text-xs font-medium bg-[#222222] border border-amber-500 rounded text-white outline-none font-mono"
              />
            </form>
          ) : (
            <span
              ...
              className={
                ...
                (isFolder
                  ...
                  : 'text-zinc-300 group-hover/qrow:text-zinc-100')
              }
            >
              {item.name}
            </span>
          ...
          {!isEditing && (
            <div className="relative">
              <button
                ...
                title="Options"
                className="opacity-0 group-hover/qrow:opacity-100 p-1 text-zinc-500 hover:text-zinc-200 hover:bg-zinc-800 rounded transition-all cursor-pointer"
              >
              ...
              {isMenuOpen && (
                <div
                  ref={queryMenuRef}
                  onClick={(e) => e.stopPropagation()}
                  className="absolute right-0 top-full mt-1 w-40 bg-[#181818] border border-[#2b2b2b] rounded-lg shadow-2xl py-1 z-50 text-xs text-zinc-300 backdrop-blur-md"
                >
                  {isFolder ? (
                    <>
                      <button
  ...
  return (
    <div
      ...
      className="bg-surface-900 border-r border-border-subtle flex flex-col h-full select-none flex-shrink-0 relative group/sidebar font-sans"
    >
      {/* Search Filter Input */}
      <div className="p-2 border-b border-border-subtle bg-surface-850/50">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-2.5 py-1.5 bg-surface-800 border border-border/60 rounded-md text-xs text-gray-200 placeholder-gray-500 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all font-mono text-[11px]"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-border-subtle/60">
        ...
        <div className="p-2">
          ...
          <div
            ...
            className="px-2 py-1.5 flex items-center justify-between hover:bg-surface-800/60 rounded-lg cursor-pointer transition-colors select-none group/expheader mb-1"
          >
            <div className="flex items-center gap-1.5">
              <ChevronRight
                className={'w-3.5 h-3.5 text-zinc-400 transition-transform duration-200 ' + (isExplorerOpen ? 'rotate-90' : '')}
              />
            ...
            <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
              <button
                ...
                className="p-1 rounded-md text-gray-400 hover:text-gray-200 hover:bg-surface-750 transition-colors cursor-pointer"
              >
                  ...
                  <div key={connId || conn.name} className="rounded-lg overflow-hidden group/server">
                    ...
                    <div
                      ...
                      className={
                        ...
                        (isServerConnected
                          ? 'bg-surface-800 text-brand-300 font-medium'
                    ...
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <Server
                          className={
                            ...
                            (isServerConnected ? 'text-brand-400' : 'text-gray-400')
                          }
                        />
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover/server:opacity-100 p-1 text-gray-500 hover:text-rose-400 hover:bg-surface-750 rounded transition-all cursor-pointer"
                        >
                    ...
                    {/* Databases List */}
                    {isExpanded && (
                      <div className="pl-6 pr-1 py-1 space-y-0.5 border-l border-border/40 ml-4 my-0.5">
                        {isLoadingDbs && (
                          <div className="flex items-center gap-2 py-1.5 px-2 text-xs text-gray-400">
                        ...
                        {!isLoadingDbs && databases.length === 0 && (
                          <div className="py-1 px-2 text-[11px] text-gray-500 italic">
                            No databases found
                          </div>
                        )}
                                ...
                                <div className="flex items-center gap-2 truncate">
                                  <Database
                                    className={
                                      ...
                                      (isCurrentDb ? 'text-emerald-400' : 'text-gray-500')
                                    }
                                  />
        ...
        <div className="p-2">
          ...
          <div
            ...
            className="px-2 py-1.5 flex items-center justify-between hover:bg-surface-800/60 rounded-lg cursor-pointer transition-colors select-none group/qheader mb-1"
          >
            <div className="flex items-center gap-1.5">
              <ChevronRight
                className={'w-3.5 h-3.5 text-zinc-400 transition-transform duration-200 ' + (isQueriesOpen ? 'rotate-90' : '')}
              />
            ...
            <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
              ...
              <button
                ...
                title="New SQL Query"
                className="p-1 rounded-md bg-amber-500/20 text-amber-300 hover:bg-amber-500 hover:text-white border border-amber-500/30 transition-all cursor-pointer"
              >
                <Plus className="w-3.5 h-3.5" />
              </button>
            </div>
